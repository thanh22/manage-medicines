...
$config = array(
    ...
    */
    ...
    'relative_image_creation_name_to_append'  => array( '_thumb', '_avatar' ), //name to append on filename
    'relative_image_creation_width'           => array( 80, 350 ), //width of image
    'relative_image_creation_height'          => array( 65, 255 ), //height of image
    /*
     * $option:     0 / exact = defined size;
     *              1 / portrait = keep aspect set height;
     *              2 / landscape = keep aspect set width;
