                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control " type="text" value="{{old('science_name')}}"  name="science_name" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="" name="feature_image" class="form-control" id="image"  value="{{old('feature_image')}}">
                                        <div class="input-group-addon">
                                            <a data-toggle="modal" href='#modal-id' class="btn btn-success">Chọn</a>
                                        </div>
                                    </div>
                                    <img src="{{old('feature_image')}}" id="show_img" alt="" width="156">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" type="text" value="{{old('purpose_use')}}"  name="purpose_use" >
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control " type="text" value="{{old('part_used')}}"  name="part_used" >
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" type="text" value="{{old('pharmaceutical_substance')}}"  name="pharmaceutical_substance" >
