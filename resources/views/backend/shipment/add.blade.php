                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control input-code" type="text" value="{{old('code')}}"  name="code" >
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control input-part-use" type="text" value="{{old('part_use')}}"  name="part_use" >
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <input type="date" class="form-control input-created_date" name="created_date" value="" required>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control input-import-price" type="text" value="{{old('import_price')}}"  name="import_price" placeholder="Đơn vị VNĐ">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control input-price" type="text" value="{{old('price')}}"  name="price" placeholder="Đơn vị VNĐ">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <select name="status" id="" class="form-control" required>
                                            ...
                                            <option value="0">Đang nuôi trồng</option>
                                            <option value="1">Đang thu hái</option>
                                            <option value="2">Đang sơ chế</option>
                                            <option value="3">Đang bảo quản</option>
                                            <option value="4">Đang vận chuyển</option>
                                            <option value="5">Đang chế biến</option>
                                            <option value="6">Đã nhận</option>
                                            <option value="7">Đang trả lại/thu hồi</option>
                                        </select>
